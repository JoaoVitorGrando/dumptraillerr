...
export default function FAQ() {
  ...
  const hours = API_CONFIG.contact.hours;

  const questions = [
    ...QUESTIONS,
    {
      q: "What phone number should I use to contact FAGU?",
      a: `You can call us directly at ${phone}.`,
    },
    {
      q: "What is the best email to reach FAGU?",
      a: `Send your questions to ${email} and our team will respond as soon as possible.`,
    },
    {
      q: "What are FAGU's support hours?",
      a: `Our current support hours are ${hours}.`,
    },
  ];
