...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="py-16 sm:py-20 md:py-28 bg-grid-dark text-white">
      <div className="container-page">
        ...
        <ol className="mt-12 sm:mt-14 grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {STEPS.map((s) => (
            <li
              key={s.n}
            ...
            >
              ...
              <h3 className="mt-5 sm:mt-6 text-lg sm:text-xl font-bold">{s.title}</h3>
              <p className="mt-2 text-white/70 leading-relaxed text-sm sm:text-base">{s.text}</p>
            </li>
          ))}
        </ol>
        ...
        <div className="mt-12 sm:mt-14 grid sm:grid-cols-[auto,1fr] items-start sm:items-center gap-4 sm:gap-6 rounded-2xl border-l-4 border-brand-yellow bg-white/[0.04] p-5 sm:p-6 md:p-8">
          ...
          <div>
            <h4 className="text-lg sm:text-xl font-bold">Delivery the day before</h4>
