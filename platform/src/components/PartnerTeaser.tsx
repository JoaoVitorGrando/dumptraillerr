...
const ROLES = [
  {
    ...
    pitch: "Put your fleet to work with steady demand from roofing crews and contractors.",
    cta: "Become an Owner",
    icon: "trailer",
  },
  {
    ...
    pitch: "Open a recurring rental account so your team can book in seconds.",
  ...
  },
  {
    ...
    pitch: "Use your truck to deliver and pick up trailers — up to 4 movements per day.",
    cta: "Apply to Drive",
    icon: "truck",
  },
];
...
export default function PartnerTeaser() {
  return (
    <section id="partner" className="py-16 sm:py-20 md:py-28 bg-grid-dark text-white">
      <div className="container-page">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="mt-3 sm:mt-4 text-white/75 text-base sm:text-lg">
            ...
            Pick your role to get started — each path has its own quick onboarding form.
          </p>
        </div>
          ...
          {ROLES.map((r) => (
            <li key={r.slug}>
              ...
              >
                ...
                <p className="text-[10px] uppercase tracking-[0.18em] text-white/55 font-semibold">{r.eyebrow}</p>
                <h3 className="mt-1 font-display text-xl sm:text-2xl font-extrabold leading-tight">{r.title}</h3>
                <p className="mt-3 text-white/75 text-sm sm:text-base leading-relaxed">{r.pitch}</p>
        ...
        <div className="mt-8 sm:mt-10 text-center text-sm text-white/60">
          ...
          <Link href="/partner" className="text-brand-yellow font-semibold hover:underline">
